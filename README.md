...
├── docs/
│   ├── .claude_brouillon-donnees.md  # brouillon de la page « Organisation des données », à valider puis à déplacer dans 03-architecture/
│   ├── .claude_brouillon-import-inbox.md  # brouillon de la page « Import de l'inbox », à valider puis à déplacer dans 03-architecture/
